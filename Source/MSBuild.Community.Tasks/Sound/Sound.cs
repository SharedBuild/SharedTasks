...
namespace MSBuild.Community.Tasks
{
    ...
    public class Sound : Task
    {
        ...
        private NAudio.Wave.AudioFileReader soundPlayer => new(SoundLocation);
        ...
        {
            set => SoundLocation = Path.Combine(Environment.SystemDirectory, value);
        }
